...
import { Bitcoin, Import, TrendingUp } from "lucide-react"
...
export function HistoryChartComponent({name,price}:coinDetails) {
  ...
  return (
    <Card className="bg-[#0d0d1f] mt-5 mr-3 w-[100%] ">
